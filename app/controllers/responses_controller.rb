  ...
  def index
    ...
    respond_to do |format|
      ...
      format.csv do
        ...
        # Columna del nœmero de trabajadores, nivel, modalidad (cada elemento formar‡ una fila)
        ...
        stream_csv(@questionnaire.title + ".csv") do |csv|
          ...
          matriz.each do |colu|
          	csv << (colu.each do |fil|
          	 ...
          	 #ÊCada respuesta en una fila (Esta parte no se usa, siempre se va a la otra)
